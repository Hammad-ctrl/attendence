    ...
    >
      <div className=" md:w-1/2 w-full md:h-[70%] h-[90%] backdrop:blur-lg">
        ...
        <form action="" className=" flex flex-col items-center md:items-start gap-7">
          <div className="border-2 w-[90%] md:w-full rounded-md border-gray-400 h-12 relative">
            ...
            <input
              ...
              name="email"
              id=""
              className="w-full bg-transparent text-sm h-full font-semibold outline-none popins placeholder:popins text-gray-800 placeholder:text-gray-800"
            />
          </div>
          <div className="border-2 w-[90%] md:w-full rounded-md border-gray-400 h-12 relative">
            <div className="w-10 h-10 absolute top-0 right-4">
            ...
            <input
              ...
              name="password"
              id=""
              className="w-full bg-transparent h-full font-semibold outline-none popins placeholder:popins text-gray-800 placeholder:text-gray-800 text-sm"
            />
          </div>
        ...
        <div className="dont-have flex items-center justify-center mt-4">
          <p className="font-bold  popins">
            ...
            <Link className="text-blue-800" to={"/regsiter"}>
              Regsiter
            </Link>
          </p>
        </div>
